<script lang="ts">
	...
	onMount(() => {
		...
		(async () => {
			...
			const dudeBounds = {
				x: -dudeBoundsPadding,
				y: -dudeBoundsPadding,
				width: app.screen.width + dudeBoundsPadding * 2,
				height: app.screen.height + dudeBoundsPadding * 2,
			};
	...
	const LINK = 'https://pixijs.com/8.x/examples/basic/particle-container';
</script>
